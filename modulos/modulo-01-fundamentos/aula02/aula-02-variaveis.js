...
const meuNome = 'Lucas'; // Constante - O valor não pode ser alterado depois de atribuído
let minhaIdade = 30; // let - O valor pode ser alterado posteriormente
var minhaProfissao = 'Desenvolvedor'; // var - O valor pode ser alterado posteriormente, mas é recomendado usar let ou const para evitar problemas de escopo
...
{ // Escopo de bloco - Variáveis com let/const declaradas dentro deste bloco não serão acessíveis fora dele
    ...
    const meuNome = 'Lucas'; // String - Armazena texto
    const minhaIdade = 30; // Number - Armazena números
    const souDesenvolvedor = true; // Boolean - Armazena valores verdadeiros ou falsos
    const minhasHabilidades = ['JavaScript', 'Python', 'Git']; // Array - Armazena uma lista de valores
    
    const meuPerfil = { // Object - Armazena um conjunto de pares chave-valor
        nome: 'Lucas',
        idade: 30,
